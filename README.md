...
Kotlin - kotlin is the programming language that will be used for front-end in the mobile app development
...
.Net (C#) - Platform that will be used to build the backend of the mobile app
